...
export const envConfig = {
  ...
  passwordSecret: process.env.DB_PASSWORD_SECRET as string,
  jwtSecretAccessToken: process.env.JWT_SECRET_ACCESS_TOKEN as string,
  jwtSecretRefreshToken: process.env.JWT_SECRET_REFRESH_TOKEN as string,
  jwtSecretEmailVerifyToken: process.env.JWT_SECRET_EMAIL as string,
  jwtSecretPasswordResetToken: process.env.JWT_SECRET_PASSWORD_RESET as string,
  refeshTokenExpiresIn: process.env.REFRESH_TOKEN_EXPIRES_IN as string,
  ...
  //AMZ
  amzAccessKeyId: process.env.AMZ_ACCESS_KEY_ID as string,
  amzSecretAccessKey: process.env.AMZ_SECRET_ACCESS_KEY as string,
  amzRegion: process.env.AMZ_REGION as string,
